// In-page TOC: builds floating right-side TOC from h2/h3 headings.
(function () {
  ...
  const tocTitleText = isEn ? 'on this page' : 'in questa pagina';

  const toc = document.createElement('aside');
  toc.className = 'page-toc';
  toc.innerHTML = '<div class="toc-title">' + tocTitleText + '</div><nav class="toc-list"></nav>';
